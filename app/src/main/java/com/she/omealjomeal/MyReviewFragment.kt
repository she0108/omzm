...
import com.she.omealjomeal.databinding.FragmentMyReviewBinding
...
class MyReviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var adapter = MyReviewRecyclerAdapter()

        userRef.child(SaveThings.userID).child("soundIdList").get().addOnSuccessListener {
            adapter.listSoundID = it.value.toString().split("/").toMutableList()
