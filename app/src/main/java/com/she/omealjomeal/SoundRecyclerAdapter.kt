...
class SoundRecyclerAdapter: RecyclerView.Adapter<SoundRecyclerAdapter.SoundRecyclerHolder>() {
    ...
    inner class SoundRecyclerHolder(val binding: SoundRecyclerBinding): RecyclerView.ViewHolder(binding.root) {
            ...
            soundRef.child(soundID).get().addOnSuccessListener {
                it.getValue(Sound::class.java)?.let { sound ->
                    ...
                    restaurantRef.child(sound.restaurantId).child("name").get().addOnSuccessListener {
                        ...
                        binding.textRestaurant.text = it.value.toString()
